...
import { Shield, Award, Users, Clock, CheckCircle, Mail, Phone, MapPin, ChevronDown, ChevronUp, Building, Truck, Star, Factory } from "lucide-react";

const serviceCities = [
  // Delhi NCR
  "New Delhi", "South Delhi", "North Delhi", "East Delhi", "West Delhi", "Central Delhi", "Gurgaon", "Noida", "Faridabad", "Ghaziabad",
  // Uttar Pradesh
  "Lucknow", "Kanpur", "Agra", "Varanasi", "Meerut", "Allahabad", "Bareilly", "Moradabad", "Aligarh", "Gorakhpur", "Mathura", "Firozabad",
  // Haryana
  "Gurugram", "Faridabad", "Panipat", "Hisar", "Karnal", "Rohtak", "Ambala", "Yamunanagar", "Sirsa", "Jind", "Sonipat", "Palwal",
  // Punjab
  "Chandigarh", "Ludhiana", "Amritsar", "Jalandhar", "Patiala", "Mohali", "Bathinda", "Hoshiarpur", "Moga", "Pathankot",
  // Rajasthan
  "Jaipur", "Jodhpur", "Udaipur", "Kota", "Ajmer", "Bikaner", "Alwar", "Bhilwara", "Sikar", "Pali",
  // Maharashtra
  "Mumbai", "Pune", "Nashik", "Aurangabad", "Nagpur", "Thane", "Solapur", "Kolhapur", "Sangli", "Satara"
];
...
const BrandCard = ({ brand, index }) => (
  <motion.div 
    ...
    className="bg-gradient-to-r from-slate-50 to-slate-100 hover:from-slate-100 hover:to-slate-200 px-4 py-2 rounded-lg text-sm border border-slate-300 text-slate-700 shadow-sm transition-all duration-300 hover:shadow-md text-center font-semibold hover:scale-105"
  >
    {brand}
  </motion.div>
);
...
export default function AboutSection() {
  ...
  const companyStats = [
    { icon: Factory, title: "Leading", subtitle: "Steel Stockist & Supplier", color: "blue", delay: 0.1 },
    { icon: Users, title: "Pan India", subtitle: "Distribution Network", color: "green", delay: 0.2 },
    { icon: Truck, title: "All Sizes", subtitle: "Industrial & Construction", color: "purple", delay: 0.3 },
    { icon: CheckCircle, title: "JSW Neo Steel", subtitle: "Authorized Distributor", color: "indigo", delay: 0.4 }
  ];

  const contactInfo = [
    {
      icon: MapPin,
      title: "Branch Office & Godown",
      description: "D-1/115 Phase-2, Mayapuri Industrial Area, New Delhi-110064",
      bgColor: "bg-blue-100",
    ...
    },
    {
      icon: MapPin,
      title: "KHASRA NO.",
      description: "634, Hiran Kudna Village, Muneka, New Delhi - 110041",
    ...
    },
    {
      ...
      description: "E-126, Bulandshahr Road, Loha Mandi, Industrial Area, Ghaziabad, UP-201009",
    ...
    },
    {
      icon: Phone,
      title: "Contact",
      description: "+91 93122 36954 | +91 93122 40849",
    ...
    },
    {
      icon: Mail,
      title: "Email",
      description: "HariomSteelInfra@gmail.com",
      bgColor: "bg-red-100",
      iconColor: "text-red-600"
    }
  ];

  const primaryBrands = ["SAIL", "TATA", "JSW", "JINDAL", "PANTHER"];
  const secondaryBrands = ["RASHMI", "RATHI", "KAMDHENU", "JINDAL", "PRIME GOLD", "SWROOP", "RANA", "K.L.", "CENTURY"];
    ...
    <section id="about" className="py-20 bg-gradient-to-b from-slate-50 via-blue-50 to-white min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center mb-16">
          ...
          >
            About <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">HARIOM STEEL INFRA</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }} 
            whileInView={{ opacity: 1, y: 0 }} 
          ...
          >
            Leading stockists and suppliers of TMT Rebars across India - Authorized JSW Neo Steel Distributor
          </motion.p>
        </div>
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200 bg-white/80 backdrop-blur-sm">
              <img
                ...
                alt="Hariom Steel Infra TMT Rebars and Steel Products"
            ...
            >
              ...
              <div>
                <h4 className="font-bold text-slate-800 text-lg">JSW Authorized</h4>
                <p className="text-slate-600 text-sm">Distributor</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <h4 className="font-bold text-slate-800 text-lg">Pan India</h4>
                <p className="text-slate-600 text-sm">Service Network</p>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div>
              ...
              <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
                <p>
                  <span className="font-semibold text-slate-800">HARIOM STEEL INFRA PVT LTD.</span> is a leading stockist and supplier of TMT Rebars across India. As an authorized distributor of JSW Neo Steel (U.P), we supply TMT Rebars in all required sizes for various industrial and construction applications.
                </p>
                <p>
                  We specialize in TMT Rebars (Full Length & Short Length) with premium brands including SAIL, TATA, JSW, JINDAL, and PANTHER. Our extensive product range also includes Angles, Girders, Channels, Square Bars, Plates, Pipes, Sheets, and more.
                </p>
                <p>
                  Additionally, we provide secondary steel from trusted manufacturers like RASHMI, RATHI, KAMDHENU, JINDAL, PRIME GOLD, SWROOP, RANA, K.L., and CENTURY. With our pan-India distribution network, we ensure quality steel products reach you wherever you are across the country.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-slate-50 to-slate-100 rounded-2xl p-6 border border-slate-200">
              <h3 className="font-bold text-lg text-slate-800 mb-4">Primary Brands</h3>
              <div className="flex flex-wrap gap-2 mb-4">
                {primaryBrands.map((brand, index) => (
                  <BrandCard key={brand} brand={brand} index={index} />
                ))}
              </div>
              <h4 className="font-semibold text-md text-slate-700 mb-3">Secondary Steel Brands</h4>
        ...
        <motion.div 
          ...
          viewport={{ once: true }} 
          transition={{ duration: 0.6 }}
          className="bg-white rounded-3xl p-10 shadow-xl border border-slate-200 mb-20"
        >
          ...
          <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
            <p className="text-slate-700 font-semibold text-center">
              <span className="text-blue-600">CIN:</span> U24109DL2025PTC442911 | 
              <span className="text-green-600 ml-2">PAN:</span> AAHCH7554G
            </p>
            <p className="text-center text-lg font-bold text-slate-800 mt-2">
        ...
        >
          ...
          <p className="text-slate-600 mb-8 text-lg leading-relaxed">
            Our extensive pan-India distribution network ensures timely delivery of quality steel products to major cities and industrial areas across the country.
          </p>
